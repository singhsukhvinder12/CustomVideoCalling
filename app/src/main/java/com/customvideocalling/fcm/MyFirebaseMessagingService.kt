package com.customvideocalling.fcm
...
import com.customvideocalling.views.SplashActivity
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun sendRegistrationToServer(token: String) {
        ...
        sharedPref.putObject(MyApplication.instance.applicationContext,GlobalConstants.DEVICETOKEN,token)
