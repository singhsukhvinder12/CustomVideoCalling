...
import com.customvideocalling.RideListAdapter
...
class MainActivity : BaseActivity() {
    ...
    override fun getLayoutId(): Int {
        return com.customvideocalling.R.layout.activity_main
    }
...
//set APp BAckground using Image
        ...
        mainViewModel!!.isClick.observe(this, Observer<String> {
            val i = Intent(applicationContext, VideoChatViewActivity::class.java)
            startActivity(i)
        })
