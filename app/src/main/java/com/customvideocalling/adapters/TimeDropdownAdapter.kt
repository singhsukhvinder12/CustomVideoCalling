...
class TimeDropdownAdapter(val context: Context, var dropDownList: ArrayList<String>?) :
        BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (convertView == null) {
            view = mInflater.inflate(R.layout.days_dropdown_layout, parent, false)
        ...
        vh.label.text = dropDownList!![position]
        //}
